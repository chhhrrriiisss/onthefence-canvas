define('Bale', [
	...
	Bale = function(x, y, image, data){
		
		// Defaults & Settings
		var that = this;	
		this.x = x || 0;
		this.y = y || 0;
		this.data = {c: data.category, a: data.s1, b: data.s2};
		this.defaultX = x;
		this.defaultY = y;	
		this.startY = -300;
        ...
        // Text Label
        this.data.c = fnc.splitLine(this.data.c, 11);
        this.label = new createjs.Text(this.data.c, "21px Otari", "#9A5628");  
		...
		// Display Binds
		this.graphics.on("click", function(evt) {	
